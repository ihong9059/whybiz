...
///////////////////////////////////////////kwlee
extern uint8_t RF_OUTPUT,RF_CHANNEL,SF_DR,RF_BW;
                        ...
                        case MAC_COMMAND_DATA_REQUEST:
                        {
                            ...
                            case MAC_COMMAND_BEACON_REQUEST:
                                ...
                                if(MiWiPROStateMachine.bits.memberOfNetwork)
                                {
                                    ...
                                    //if( MACRxPacket.Payload[1] != Conv_channel )//KWLEE
