...
#define MAX_HOPS    (NUM_COORDINATOR+1)				//ihkim
...
typedef struct _NET_INFO
{
	...
	uint8_t		STXL;			//ihkim_20220617
	uint8_t		STX1;			//ihkim_20220617
	uint8_t		STX2;			//ihkim_20220617
	uint8_t		STX3;			//ihkim_20220617
	uint8_t		STX_Status;		//ihkim_20220617
	uint8_t		ETXL;			//ihkim_20220617
	uint8_t		ETX1;			//ihkim_20220617
	uint8_t		ETX2;			//ihkim_20220617
	uint8_t		ETX3;			//ihkim_20220617
	uint8_t		Text_Status;	//ihkim_20220617
	uint16_t	Uart_Borate;	//ihkim_20220617	
	uint8_t		echo_chk;		//ihkim_20221208
...
extern uint32_t ChannelMAP;
extern uint8_t myLongAddress[];

extern NET_INFO networkInfo;
